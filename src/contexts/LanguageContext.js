...
export const translations = {
  en: {
    ...
    noTasksToday: 'You have no tasks scheduled for today.',
    noTasksTomorrow: 'You have no tasks scheduled for tomorrow.',
    noTasksNext3Days: 'You have no tasks scheduled for the next 3 days.',
    noTasksNextWeek: 'You have no tasks scheduled for the next week.',
    noTasksThisWeek: 'You have no tasks scheduled for this week.',
    noTasksThisMonth: 'You have no tasks scheduled for this month.',
    task: 'task',
    tasks: 'tasks',
    high: 'High',
    medium: 'Medium',
  ...
  fr: {
    ...
    noTasksToday: 'Vous n\'avez aucune tâche prévue pour aujourd\'hui.',
    noTasksTomorrow: 'Vous n\'avez aucune tâche prévue pour demain.',
    noTasksNext3Days: 'Vous n\'avez aucune tâche prévue pour les 3 prochains jours.',
    noTasksNextWeek: 'Vous n\'avez aucune tâche prévue pour la prochaine semaine.',
    noTasksThisWeek: 'Vous n\'avez aucune tâche prévue pour cette semaine.',
    noTasksThisMonth: 'Vous n\'avez aucune tâche prévue pour ce mois.',
    task: 'tâche',
    tasks: 'tâches',
    high: 'Élevée',
    medium: 'Moyenne',
